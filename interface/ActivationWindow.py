...
class ActivationWindow(BaseInterface, BaseDialog):
    ...
    def __init__(self):
        ...
        self.Input1.setStyleSheet(self.Style.Object.MainFrame_Activation_Window_Input())
        self.Input1.setPlaceholderText(self.Lang.GenerateSignatureVerificationCode)
        Layout.addWidget(self.Input1)

        self.Btn1 = QPushButton("  " + self.Lang.GenerateSignatureVerificationCode)  # 验签码按钮
        self.Btn1.setFixedHeight(30)  # 设置固定高度
        self.Btn1.setStyleSheet(self.Style.Object.MainFrame_Activation_Window_Btn())
        self.Btn1.clicked.connect(self.GenerateSecretKey)  # 连接槽函数
        self.Btn1.setIcon(QIcon(GCODE))
        Layout.addWidget(self.Btn1)

        self.Input2 = QTextEdit()
        self.Input2.setStyleSheet(self.Style.Object.MainFrame_Activation_Window_Input())
        ...
        self.Btn2.setStyleSheet(self.Style.Object.MainFrame_Activation_Window_Btn())
    ...
    def CheckActivationCode(self):
        ...
        if Result["State"] != True:
            ...
            self.close()
            MSGBOX().COMPLETE(self.Lang.ActivatedSuccessfully + " " + self.Lang.MaxAccounts + " " + str(Result["ID"]))
